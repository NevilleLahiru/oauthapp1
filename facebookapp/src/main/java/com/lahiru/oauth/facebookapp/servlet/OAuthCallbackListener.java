package com.lahiru.oauth.facebookapp.servlet;
...
import com.lahiru.oauth.facebookapp.data.ResourceDataHolder;
import com.lahiru.oauth.facebookapp.util.FileOperations;
...
public class OAuthCallbackListener extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        if (authorizationCode != null && authorizationCode.length() > 0) {
            ...
            final String CLIENT_ID = "782655328526130";
            final String CLIENT_SECRET = "8297296856a5fbdfb2bd44673fcc17b1";
